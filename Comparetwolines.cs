...
namespace LineComparison
{
    public class Comparetwolines
    {
        public void Comparelines()
        {
            ...
            double y2 = Convert.ToDouble(Console.ReadLine());     //upto LineA
            ...
            double y4 = Convert.ToDouble(Console.ReadLine());      //upto LineB

            double a = Math.Pow((x2 - x1), 2);
            double b = Math.Pow((y2 - y1), 2);
            double result1 = Math.Sqrt(a + b);    //lineA

            double c = Math.Pow((x4 - x3), 2);
            double d = Math.Pow((y4 - y3), 2);
            double result2 = Math.Sqrt(a + b);   //lineB
